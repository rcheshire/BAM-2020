...
!! cout <<  "endyr_rec_phase1" << endyr_rec_phase1 << endl;
...
init_int n_iter_spr;
 !! cout << "n_iter_spr" <<  n_iter_spr << endl;
...
int n_iter_msy;
 ...
 END_CALCS
 !! cout << "n_iter_msy" <<  n_iter_msy << endl;
...
number nyrs_rec_spr;
 ...
 END_CALCS 
 !! cout <<  "nyrs_rec_spr" <<  nyrs_rec_spr << endl; 
...
!! cout << "styr_CVT_cpue" <<  styr_CVT_cpue << endl;
init_int endyr_CVT_cpue;
!! cout << "endyr_CVT_cpue" << endyr_CVT_cpue << endl;
...
!! cout <<  "obs_CVT_cpue" <<  obs_CVT_cpue << endl;
// Length Compositions 
init_int nyr_CVT_lenc;
!! cout <<  "nyr_CVT_lenc" << nyr_CVT_lenc << endl;
init_ivector yrs_CVT_lenc(1,nyr_CVT_lenc);
!! cout <<  "yrs_CVT_lenc" << yrs_CVT_lenc << endl;
...
!! cout << "nfish_CVT_lenc" << nfish_CVT_lenc << endl;
// Age Compositions 
...
//switch here if var_rec_dev <=dzero 
  ...
  for(iyear=styr; iyear<=endyr; iyear++)
  {
        L_total_klb_yr(iyear)=pred_cH_L_klb(iyear);
        L_total_knum_yr(iyear)=pred_cH_L_knum(iyear);
  ...
  L_total_num=L_cH_num;   //landings at age in number fish
  L_total_klb=L_cH_klb;   //landings at age in klb whole weight
 
  D_total_num=(D_cH_num);          //discards at age in number fish
  D_total_klb=D_cH_klb;            //discards at age in klb whole weight
...
REPORT_SECTION
  ...
  if (last_phase())  
  {
    ...
    #include "rgch_make_Robject4.cxx"   // write the R-compatible report
