//##--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>
//##
//##  SEDAR 53  Red Grouper assessment model, Fall 2016
...
// Length Compositions 
init_int nyr_CVT_lenc;
init_ivector yrs_CVT_lenc(1,nyr_CVT_lenc);
init_vector nsamp_CVT_lenc(1,nyr_CVT_lenc);
init_vector nfish_CVT_lenc(1,nyr_CVT_lenc);
init_matrix obs_CVT_lenc(1,nyr_CVT_lenc,1,nlenbins);
...
init_vector cO_L_cv(styr_cO_L,endyr_cO_L);
...
init_vector nfish_cO_lenc(1,nyr_cO_lenc);
...
init_vector set_log_dm_cH_lc(1,7);    //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_cO_lc(1,7);    //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_HB_lc(1,7);    //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_GR_lc(1,7);    //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_HB_D_lc(1,7);  //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_CVT_lc(1,7);   //Dirichlet-multinomial overdispersion parameter
...
//init_vector set_selpar_A50_cO1(1,7);
init_vector set_selpar_A50_cO2(1,7);
init_vector set_selpar_A50_cO3(1,7);
init_vector set_selpar_slope_cO2(1,7);
init_vector set_selpar_A502_cO2(1,7); 
init_vector set_selpar_slope2_cO2(1,7);
...
init_vector set_log_q_CVT(1,7);     //catchability coefficient (log) for SERFS index  

//--mean F's in log space --------------------------------
init_vector set_log_avg_F_cH(1,7);
init_vector set_log_avg_F_cO(1,7);
...
init_vector set_log_F_dev_cO(1,3); 
...
init_vector set_log_F_dev_cO_vals(styr_cO_L,endyr_cO_L);
...
init_number set_w_I_CVT;        //weight for CVT index
init_number set_w_lc_cH;        //weight for comm handline len comps
init_number set_w_lc_cO;        //weight for comm other len comps
init_number set_w_lc_HB;        //weight for headboat len comps
init_number set_w_lc_GR;		//weight for the recreational length comps
init_number set_w_lc_HB_D;		//weight for the headboat discard length comps   
init_number set_w_lc_CVT;		//weight for the SERFS length comps  
...
////--------------Growth--------------------------------------------------------------------------- 
  ...
  matrix len_cO_mm(styr,endyr,1,nages);          //mean length at age of commercial other landings in mm 
  matrix wholewgt_cO_klb(styr,endyr,1,nages);    //whole wgt of commercial other landings in 1000 lb   
  ...
  matrix lenprob_cO(1,nages,1,nlenbins);     //distn of size at age in cO
...
//----Predicted length and age compositions
  ...
  matrix pred_CVT_lenc(1,nyr_CVT_lenc,1,nlenbins);  
...
//Computed effective sample size for output (not used in fitting)
  vector neff_cH_lenc_allyr(styr,endyr);
...
//---Stock-Recruit Function (Beverton-Holt, steepness parameterization)----------
  ...
  init_bounded_number log_dm_cO_lc(log_dm_cO_lc_LO,log_dm_cO_lc_HI,log_dm_cO_lc_PH);
  ...
  init_bounded_number log_dm_CVT_lc(log_dm_CVT_lc_LO,log_dm_CVT_lc_HI,log_dm_CVT_lc_PH);
...
//Commercial handline-------------------------------------------------
  ...
  vector sel_cO_block1(1,nages);
  vector sel_cO_block2(1,nages);
  vector sel_cO_block3(1,nages);

  init_bounded_number selpar_A50_cO2(selpar_A50_cO2_LO,selpar_A50_cO2_HI,selpar_A50_cO2_PH);
  init_bounded_number selpar_A50_cO3(selpar_A50_cO3_LO,selpar_A50_cO3_HI,selpar_A50_cO3_PH);
  init_bounded_number selpar_slope_cO2(selpar_slope_cO2_LO,selpar_slope_cO2_HI,selpar_slope_cO2_PH);
  init_bounded_number selpar_A502_cO2(selpar_A502_cO2_LO,selpar_A502_cO2_HI,selpar_A502_cO2_PH);
  init_bounded_number selpar_slope2_cO2(selpar_slope2_cO2_LO,selpar_slope2_cO2_HI,selpar_slope2_cO2_PH);
  
  vector selpar_A50_cO2_out(1,8);
  vector selpar_A50_cO3_out(1,8);
  vector selpar_slope_cO2_out(1,8);
  vector selpar_A502_cO2_out(1,8);
  vector selpar_slope2_cO2_out(1,8);
...
//---Landings in numbers (total or 1000 fish) and in wgt (whole klb)--------------------------------------------------
  ...
  vector pred_cO_L_klb(styr,endyr);      //yearly landings in 1000 lb whole summed over ages
...
////---MSY calcs----------------------------------------------------------------------------
  ...
  number F_cO_prop;       //proportion of F_sum attributable to cH, last X=selpar_n_yrs_wgted yrs  
...
////--------Mortality------------------------------------------------------------------
  ...
  init_bounded_number log_avg_F_cO(log_avg_F_cO_LO,log_avg_F_cO_HI,log_avg_F_cO_PH);
  vector log_avg_F_cO_out(1,8);  
  init_bounded_dev_vector log_F_dev_cO(styr_cO_L,endyr_cO_L,log_F_dev_cO_LO,log_F_dev_cO_HI,log_F_dev_cO_PH);
  vector log_F_dev_cO_out(styr_cO_L,endyr_cO_L);
  ...
  //number F_init_cO_prop;  //proportion of F_init attributable to cO, first X yrs
